...
public class CPHomeSteps{
    private CP_Page cP_Page=new CP_Page(DriverManager.getDriver());
...
//    }
    ...
    public void selectOptionszfromMenu(String menuName,String menuOption) {
        ...
        ExtentManager.getTest().info("Selected the option "+menuOption+" from the menu "+menuName);
    }
    ...
    public void validateVideosOrNewsFeeds(String feedType, String count) {
        ...
        ExtentManager.getTest().info("validates list of Hyperlinks");
    }
    ...
    public void validateCountOfFeedsbasedOnDays(String feedType,String daysOrHrsCond,String count) {
        ...
        ExtentManager.getTest().info("validates count of feeds based on days");
    }
}
